  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="p-6 space-y-6">
        {/* Warning Banner */}
        <div className="flex items-start gap-4 p-6 rounded-lg bg-destructive/5 border-2 border-destructive/20">
          <div className="p-3 rounded-full bg-destructive/10">
            <AlertTriangle className="w-6 h-6 text-destructive" />
          </div>
          <div>
            <h3 className="font-semibold text-destructive">Break-Glass Override Zone</h3>
        ...
        <div className="grid grid-cols-3 gap-6">
            ...
            <div className="audit-card">
              <div className="audit-card-header">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-semibold">Execute Override</h3>
                </div>
              </div>
          ...
          <div>
            <div className="audit-card">
              <div className="audit-card-header">
                <h3 className="font-semibold">Recent Overrides</h3>
              </div>
                  ...
                  <div key={override.id} className="p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium">{override.action}</p>
                        <p className="text-xs text-muted-foreground mt-1 truncate">
                          {override.reason}
                        </p>
                        <div className="flex items-center gap-2 mt-2 text-xs text-muted-foreground">
                          <Clock className="w-3 h-3" />
                          <span>{override.timestamp}</span>
                        </div>
                      </div>
                    </div>
                  </div>
